function f(query) {
     ...
     * @param {void} func Callback when the event is fired
     */
 ...
 * @param {{tag: string, innerHTML?: string, textContent?: string, id?: string, classList: string, src?: string, width?: number, height?: number, children: HTMLCollection}} options The options for the new element.
